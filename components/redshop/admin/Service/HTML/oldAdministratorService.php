...
namespace Redshop\Component\Redshop\Administrator\Service\HTML;
...
class AdministratorService
{
	...
	public function association($articleid)
	{
		...
		if ($associations = Associations::getAssociations('com_redshop', '#__users', 'com_redshop.item', $articleid))
		{
