...
<form action="<?php echo Route::_('index.php?option=com_redshop&view=user&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" name="adminForm" id="users-form" class="form-validate">
